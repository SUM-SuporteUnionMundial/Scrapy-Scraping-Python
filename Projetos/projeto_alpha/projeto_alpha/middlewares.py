...
class ProjetoAphaSpiderMiddleware:
...
class ProjetoAlphaDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class RandomUserAgentMiddleware(object):
    # um middleware para alterar o user-agent dos requests de forma aleatória
    def __init__(self):
        # uma lista de user-agents possíveis
        self.user_agents = [
    ...
    def process_request(self, request, spider):
        ...
        # atribuir o user-agent ao request
